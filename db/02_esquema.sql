-- ============================================================================
--  gestion-alquileres :: 02 - Esquema (identico a la migracion Flyway V1)
--  Ejecutar como el usuario de la aplicacion sobre la base 'alquileres':
...
-- ---------------------------------------------------------------------------
-- Permisos para el rol de la aplicacion (solo necesario en instalacion manual,
-- cuando el esquema se ha creado con un usuario distinto al de la aplicacion).
-- ---------------------------------------------------------------------------
-- GRANT ALL PRIVILEGES ON ALL TABLES    IN SCHEMA public TO alquileres;
-- GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO alquileres;
